...
export default class OTP extends Component {
    ...
    componentDidMount() {
        var emails = db.state.profile._email;
        try {
            fetch('http://192.168.43.47:4000/otp/', {
                method: 'POST',
                headers: {
        ...
        if (this.state.isLoading) {
            ...
            return (
                ...
                <View style={s.Container} >
                    ...
                    <TouchableOpacity style={s.BackToLogin} onPress={() => { this.props.navigation.replace('login') }}>
                    ...
                    <View style={{ marginLeft: 10, marginBottom: 10, flexDirection: "row", justifyContent: 'flex-end', }}>
                    ...
                    <View style={s.ButtonForm}>
                        ...
                        <TouchableOpacity onPress={() => { this.props.navigation.replace('otp') }}
