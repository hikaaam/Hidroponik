...
import serverSetting from './App/stack/serverSetting';
...
const ScreenOption = ({navigation}) => ({
  ...
  headerBackImage: () => (
    <Icon2 name="chevron-left" size={30} color={'white'} />
  ),
  headerTintColor: '#fff',
  headerTitleStyle: {
    fontWeight: 'bold',
